    ...
    <ul class="navbar-nav ms-auto">
      <?php if(auth()->guard()->check()): ?>
        <?php if(Auth::user()->role == 'admin'): ?>
          ...
          <li class="nav-item"><a href="<?php echo e(route('suppliers.index')); ?>" class="nav-link">Kelola Barang</a></li>
          <li class="nav-item"><a href="#" class="nav-link">Kategori</a></li>
          <li class="nav-item"><a href="#" class="nav-link">Supplier</a></li>
        <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\Laravel\inventory\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>